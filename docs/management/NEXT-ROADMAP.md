# Next Roadmap — Story Index

**Status:** The roadmap outcomes were owner-approved on 2026-08-27. They are
now decomposed into bounded story drafts awaiting owner review. No story is
active, and implementation remains paused until the owner explicitly
authorizes one.
...
validation tiers live in the linked story drafts under `next-roadmap/`.
...
| --- | --- | --- | --- | --- |
| 1 | [NR-01 — Separate SPHERE from the numbered route](next-roadmap/nr-01-separate-sphere-from-the-numbered-route.md) | Structural change | None | Draft — owner review |
| 2 | [NR-02 — Reframe SPHERE as optional guidance](next-roadmap/nr-02-reframe-sphere-as-optional-guidance.md) | Editorial refinement | NR-01 | Draft — owner review |
| 3 | [NR-03 — Limit SPHERE research to route-specific ownership](next-roadmap/nr-03-limit-sphere-research-to-route-specific-ownership.md) | Data or research change | NR-01, NR-02 | Draft — owner review |
| 4 | [NR-04 — Clarify the opening orientation and BLUE goal](next-roadmap/nr-04-clarify-the-opening-orientation-and-blue-goal.md) | Editorial refinement | NR-02 | Draft — owner review |
| 5 | [NR-05 — Establish compact Quick processes for early controls](next-roadmap/nr-05-establish-compact-quick-processes-for-early-controls.md) | Structural change | NR-04 | Draft — owner review |
| 6 | [NR-06 — Assign ILS research chronologically across three stages](next-roadmap/nr-06-assign-ils-research-chronologically-across-three-stages.md) | Data or research change | NR-05 | Draft — owner review |
| 7 | [NR-07 — Replace YELLOW research with bounded buildout guidance](next-roadmap/nr-07-replace-yellow-research-with-bounded-buildout-guidance.md) | Data or research change | NR-06 | Draft — owner review |
| 8 | [NR-08 — Assign PURPLE-owned research and bounded upgrades](next-roadmap/nr-08-assign-purple-owned-research-and-bounded-upgrades.md) | Data or research change | NR-07 | Draft — owner review |
| 9 | [NR-09 — Establish GREEN research and material-proof ownership](next-roadmap/nr-09-establish-green-research-and-material-proof-ownership.md) | Data or research change | NR-03, NR-08 | Draft — owner review |
| 10 | [NR-10 — Teach GREEN's Deuterium, fuel, and power loop](next-roadmap/nr-10-teach-green-deuterium-fuel-and-power-loop.md) | Editorial refinement | NR-09 | Draft — owner review |
...
No story is completed, accepted, active, or release-authorized by this
decomposition alone.
