...
- [`ils-purple-green-research-handoff-user-story.md`](ils-purple-green-research-handoff-user-story.md)
  ...
  and GREEN branch-order work. Its ILS production-map refinement is implemented
  and its automated and browser checks pass; owner validation is pending.
...
another GREEN refinement followed by fuller ILS research and production maps.
The production-map refinement is implemented and has passed focused,
